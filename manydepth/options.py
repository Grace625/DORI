...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument('--temporal',
                                 action='store_true',
                                 help='If set, DORI will be used on teacher net')
        
        self.parser.add_argument('--main_temporal',
                                 action='store_true',
                                 help='If set, DORI will be used on main net')

        self.parser.add_argument('--new_mask',
                                 action='store_true',
                                 help='new mask')

        self.parser.add_argument('--freeze_pose_only',
                                 action='store_true',
                                 help='If set, the pose network will be freezed')
